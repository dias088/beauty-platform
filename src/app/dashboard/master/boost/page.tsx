...
const PLANS = [
  {
    ...
    price: 2990,
    badge: null,
    features: ['TOP-позиция в выдаче', 'Значок TOP на карточке', '3–5× просмотров профиля', 'Полная статистика профиля'],
  },
  {
    id: '30d' as const,
    label: '30 дней',
    price: 7990,
    badge: 'Выгоднее',
    features: ['TOP-позиция в выдаче', 'Значок TOP на карточке', '3–5× просмотров профиля', 'Полная статистика профиля', 'Экономия 3 940 ₸ vs 4 недели'],
  },
]
