...
const BENEFITS = [
  { icon: Shield, title: 'Бесплатно навсегда', desc: 'Профиль, расписание и онлайн-запись без скрытых платежей' },
  { icon: Zap, title: 'Расписание автоматически', desc: 'Один раз настрой шаблон — слоты создаются сами каждую неделю' },
  { icon: Star, title: 'Beauty Score клиентов', desc: 'Видишь репутацию каждого клиента до подтверждения записи' },
]
